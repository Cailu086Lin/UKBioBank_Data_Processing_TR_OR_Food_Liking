...
###
gene_regions <- read_csv("/media/cailu/Seagate Backup Plus Drive1/data_20230311/results3/gene_regions.csv")
gene_regions<-gene_regions[!gene_regions$gene%in%gene_regions$gene[grepl("^ORA|^ORC|^ORM", gene_regions$gene)],] ##425 genes

##Chr2
g <- read_excel("/media/cailu/Seagate Backup Plus Drive1/data_20230311/results3/gene_regions.xlsx")
c2 <- read.delim("/media/cailu/Seagate Backup Plus Drive1/data_20230311/UKB_geno/bfilemaf0.1/c2flt.bim", header=FALSE)
...
v2a<-merge(v2,  v2_ana, by.x="V2", by.y="variant", all.x=T)%>%
  filter(dbSNP.annotation=="missense"|dbSNP.annotation=="frameshift")
...
c2 <- read.delim("/media/cailu/Seagate Backup Plus Drive1/data_20230311/UKB_geno/bfilemaf0.1/c1flt.bim", header=FALSE)
...
c2 <- read.delim("/media/cailu/Seagate Backup Plus Drive1/data_20230311/UKB_geno/bfilemaf0.1/c5flt.bim", header=FALSE)
...
c2 <- read.delim("/media/cailu/Seagate Backup Plus Drive1/data_20230311/UKB_geno/bfilemaf0.1/c7flt.bim", header=FALSE)
...
c2 <- read.delim("/media/cailu/Seagate Backup Plus Drive1/data_20230311/UKB_geno/bfilemaf0.1/c10flt.bim", header=FALSE)
...
##chr11
c2 <- read.delim("/media/cailu/Seagate Backup Plus Drive1/data_20230311/UKB_geno/bfilemaf0.1/c11flt.bim", header=FALSE)
...
##chr12
c2 <- read.delim("/media/cailu/Seagate Backup Plus Drive1/data_20230311/UKB_geno/bfilemaf0.1/c12flt.bim", header=FALSE)
...
v12_ana <- read_excel("ann_c12.xlsx")%>%
  select(variant,`dbSNP`,Ref,Alt, `EUR`)%>%
  drop_na(`dbSNP`)%>%
  distinct(variant, .keep_all=T)
...
##chr17
c2 <- read.delim("/media/cailu/Seagate Backup Plus Drive1/data_20230311/UKB_geno/bfilemaf0.1/c17flt.bim", header=FALSE)
...
##chr19
c2 <- read.delim("/media/cailu/Seagate Backup Plus Drive1/data_20230311/UKB_geno/bfilemaf0.1/c19flt.bim", header=FALSE)
...
##chr6
c2 <- read.delim("/media/cailu/Seagate Backup Plus Drive1/data_20230311/UKB_geno/bfilemaf0.1/c6flt.bim", header=FALSE)
...
##chr8
c2 <- read.delim("/media/cailu/Seagate Backup Plus Drive1/data_20230311/UKB_geno/bfilemaf0.1/c8flt.bim", header=FALSE)
...
##cX
c2 <- read.delim("/media/cailu/Seagate Backup Plus Drive1/data_20230311/UKB_geno/bfilemaf0.1/cXflt.bim", header=FALSE)
...
##15
c2 <- read.delim("/media/cailu/Seagate Backup Plus Drive1/data_20230311/UKB_geno/bfilemaf0.1/c15flt.bim", header=FALSE)
...
##chr3
c2 <- read.delim("/media/cailu/Seagate Backup Plus Drive1/data_20230311/UKB_geno/bfilemaf0.1/c3flt.bim", header=FALSE)
...
##
##chr9
c2 <- read.delim("/media/cailu/Seagate Backup Plus Drive1/data_20230311/UKB_geno/bfilemaf0.1/c9flt.bim", header=FALSE)
...
##chr16
c2 <- read.delim("/media/cailu/Seagate Backup Plus Drive1/data_20230311/UKB_geno/bfilemaf0.1/c16flt.bim", header=FALSE)
...
##chr22
c2 <- read.delim("/media/cailu/Seagate Backup Plus Drive1/data_20230311/UKB_geno/bfilemaf0.1/c22flt.bim", header=FALSE)
...
#v16_ana <- read_excel("v16_ana.xlsx")%>%
...
v22_ana<-v9_ana[1,]
v22_ana[1,]<-c(NA, NA, NA, NA,NA)
v2a<-merge(v2,  v22_ana, by.x="V2", by.y="variant", all.x=T)%>%
  filter(dbSNP.annotation=="missense")
...
##chr14
c2 <- read.delim("/media/cailu/Seagate Backup Plus Drive1/data_20230311/UKB_geno/bfilemaf0.1/c14flt.bim", header=FALSE)
...
v6_ana <- read_excel("ann_c14.xlsx")%>%
  select(variant,`dbSNP`,Ref,Alt, `EUR`)%>%
  drop_na(`dbSNP`)%>%
  distinct(variant, .keep_all=T)
names(v6_ana)[c(2, 5)]<-c("dbSNP.annotation", "EUR_freq")
...
c1 <- read.csv("/media/cailu/Seagate Backup Plus Drive1/data_20230311/results3/chr1_missese.csv")
c2 <- read.csv("/media/cailu/Seagate Backup Plus Drive/data_20230311/results3/chr2_missese.csv")
c3 <- read.csv("/media/cailu/Seagate Backup Plus Drive/data_20230311/results3/chr3_missese.csv")
c5 <- read.csv("/media/cailu/Seagate Backup Plus Drive/data_20230311/results3/chr5_missese.csv")
c6 <- read.csv("/media/cailu/Seagate Backup Plus Drive/data_20230311/results3/chr6_missese.csv")
c7 <- read.csv("/media/cailu/Seagate Backup Plus Drive/data_20230311/results3/chr7_missese.csv")
c8 <- read.csv("/media/cailu/Seagate Backup Plus Drive/data_20230311/results3/chr8_missese.csv")
c9 <- read.csv("/media/cailu/Seagate Backup Plus Drive/data_20230311/results3/chr9_missese.csv")
c10 <- read.csv("/media/cailu/Seagate Backup Plus Drive/data_20230311/results3/chr10_missese.csv")
c11 <- read.csv("/media/cailu/Seagate Backup Plus Drive/data_20230311/results3/chr11_missese.csv")
c12 <- read.csv("/media/cailu/Seagate Backup Plus Drive/data_20230311/results3/chr12_missese.csv")
c14 <- read.csv("/media/cailu/Seagate Backup Plus Drive/data_20230311/results3/chr14_missese.csv")
c15 <- read.csv("/media/cailu/Seagate Backup Plus Drive/data_20230311/results3/chr15_missese.csv")
c16 <- read.csv("/media/cailu/Seagate Backup Plus Drive/data_20230311/results3/chr16_missese.csv")
c17 <- read.csv("/media/cailu/Seagate Backup Plus Drive/data_20230311/results3/chr17_missese.csv")
c19 <- read.csv("/media/cailu/Seagate Backup Plus Drive/data_20230311/results3/chr19_missese.csv")
c22 <- read.csv("/media/cailu/Seagate Backup Plus Drive/data_20230311/results3/chr22_missese.csv")
cX <- read.csv("/media/cailu/Seagate Backup Plus Drive/data_20230311/results3/chrx_missese.csv")

missense_variants<-bind_rows(c1,c2,c3,c5,c6,c7,c8,c9,c10,c11,c12,c14,c15,c16,c17,c19,c22)#,cX)
...
missense_variants<-missense_variants[!(missense_variants$gene%in%c("ORAI1",
                                                                 "ORC1",
                                                                 "ORC2",
                                                                 "ORC3",
                                                                 "ORC4",
...
write.csv(missense_variants, "missense_variants_with_maf0.05.csv", row.names = F)
